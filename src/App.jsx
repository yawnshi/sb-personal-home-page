...
export default function App() {
        ...
        if (e.target.id === "btn-exit") {
          ...
          if (exitClicks === 3) {
            ...
            gameContainer.innerHTML =
              '<iframe src="https://tarfalmadani.com" class="w-full h-full border-0 absolute inset-0 z-20"></iframe>';
  ...
  return (
    <>
      ...
      <section id="space" className="relative min-h-screen flex items-center justify-center py-24 z-10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
          <div className="bg-off-black/80 backdrop-blur-md border border-brand/20 rounded-3xl p-8 md:p-12 shadow-[0_0_40px_rgba(16,185,129,0.05)]">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4 text-white">
                Personal <span className="text-brand">Space</span>
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">Something i like to share about my personal preferences</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/*  Personal Section  */}
              <div className="bg-pure-black rounded-2xl overflow-hidden border border-brand-darker p-6 card-hover transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-brand/10 flex items-center justify-center">
                    <i className="fas fa-headphones text-brand text-lg"></i>
                  </div>
                  <h3 className="text-xl font-bold text-white">On Repeat</h3>
                </div>
                <p className="text-gray-400 text-sm mb-6">My anti-mainstream playlist</p>

                {/*  YouTube Embed  */}
                <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-brand/20 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
                  <iframe
                ...
                <div className="mt-4 text-center">
                  <a
                    href="https://www.youtube.com/playlist?list=PLPirW_3Fhee_pfal-zq34cbCP7FB9k4E4"
                    target="_blank"
                    className="mx-auto inline-block px-4 py-2 border border-brand text-brand rounded-lg text-sm font-medium"
                  >
              ...
              <div className="bg-pure-black rounded-2xl overflow-hidden border border-brand-darker p-6 card-hover transition-all duration-300">
                <div className="flex items-center gap-3 mb-6">
                  <div className="w-10 h-10 rounded-full bg-brand/10 flex items-center justify-center">
                    <i className="fas fa-headphones-alt text-brand text-lg"></i>
                  </div>
                  <h3 className="text-xl font-bold text-white">Mainstream Music</h3>
                </div>
                <p className="text-gray-400 text-sm mb-6">The latest hits and popular tracks I enjoy</p>
                ...
                <div className="mt-4 text-center">
                  <a
                    href="https://youtube.com/playlist?list=PLPirW_3Fhee9Iqfah08npjgMtVpjFsN93"
                    target="_blank"
                    className="mx-auto inline-block px-4 py-2 border border-brand text-brand rounded-lg text-sm font-medium"
                  >
                    View full playlist on YouTube
